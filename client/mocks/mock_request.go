...
// Source: github.com/calypr/data-client/client/jwt (interfaces: RequestInterface)
//
// Generated by this command:
//
//	mockgen -destination=../mocks/mock_request.go -package=mocks github.com/calypr/data-client/client/jwt RequestInterface
//
...
func (m *MockRequestInterface) RequestNewAccessToken(accessTokenEndpoint string, profileConfig *jwt.Credential) error {
	m.ctrl.T.Helper()
