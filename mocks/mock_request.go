...
// Source: github.com/calypr/calypr-cli/request (interfaces: RequestInterface)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/mock_request.go -package=mocks github.com/calypr/calypr-cli/request RequestInterface
//
